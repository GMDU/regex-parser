...
data modify storage moxlib:test/it expects set value ["a","d","e","f"]
...
data modify storage moxlib:test/it expects set value ["a","b","c","c","b","f"]
data modify storage moxlib:test/it receives set from storage regex:api/match output
...
data modify storage moxlib:test/it expects set value ["a","b","d","c","c","b","d","f"]
data modify storage moxlib:test/it receives set from storage regex:api/match output
